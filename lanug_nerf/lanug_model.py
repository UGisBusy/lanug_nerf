...
# from nerfstudio.fields.vanilla_nerf_field import NeRFField as LanugField
from lanug_nerf.lanug_field import LanugField
...
@dataclass
class LanugModelConfig(ModelConfig):
...
class LanugModel(Model):
    ...
    def populate_modules(self):
        ...
        self.field_coarse = LanugField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
        )

        self.field_fine = LanugField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
        )
